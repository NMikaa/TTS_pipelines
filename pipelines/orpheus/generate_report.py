"""
Generate a markdown report from Orpheus TTS evaluation results.
...
def generate_report(results_dir: str, output: str):
    ...
    lines = [
        "# Orpheus TTS — Georgian TTS Evaluation Report",
        "",
        ...
        "| Property | Value |",
        "|----------|-------|",
        "| Architecture | Pure autoregressive LLM (Llama backbone) |",
        "| Parameters | 150M / 400M / 1B / 3B |",
        "| Base model | canopylabs/orpheus-tts |",
        "| Fine-tuning | LoRA |",
        "",
        "## Results",
        "",
