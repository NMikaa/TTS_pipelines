"""
Evaluate Fish Speech S1-mini on the FLEURS Georgian test set.
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate Fish Speech on Georgian")
    ...
    print("\n" + "=" * 50)
    print("FISH SPEECH EVALUATION RESULTS")
    print("=" * 50)
