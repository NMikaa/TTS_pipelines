"""
Generate a markdown report from OpenAudio S1-mini evaluation results.
...
def generate_report(results_dir: str, output: str):
    ...
    lines = [
        "# OpenAudio S1-mini (Fish Speech) — Georgian TTS Evaluation Report",
        "",
        ...
        "| Property | Value |",
        "|----------|-------|",
        "| Architecture | Dual AR (LLAMA text-to-semantic + DAC codec) |",
        "| Parameters | 0.5B |",
        "| Base model | fishaudio/openaudio-s1-mini |",
        "| Fine-tuning | LoRA on LLAMA component (rank=8, alpha=16) |",
        "",
        "## Results",
        "",
        "| Metric | Value |",
