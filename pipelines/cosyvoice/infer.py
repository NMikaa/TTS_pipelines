"""
CosyVoice 3 inference for Georgian.
...
def generate_single(checkpoint: str, text: str, output: str, reference_audio: str | None = None):
    raise NotImplementedError("CosyVoice 3 inference not yet implemented.")
...
def main():
    parser = argparse.ArgumentParser(description="CosyVoice 3 inference")
